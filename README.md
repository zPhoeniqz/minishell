...
- [x] Search and launch the right executable (based on the PATH variable or using arelative or an absolute path).
- [x] Use at most one global variable to indicate a received signal.
